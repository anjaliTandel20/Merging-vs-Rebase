...
export class AppComponent {
  ...
  public gitRebase: string = '';
  public gitRebaseContent: string = '';
  ...
  initValues() {
    ...
    this.gitRebase = 'What is Git Rebase';
    this.gitRebaseContent = 'Git rebase is a command that lets users integrate changes from one branch to another, and the logs are modified once the action is complete. Git rebase was developed to overcome merging’s shortcomings, specifically regarding logs.'
  }
}
